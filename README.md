...
The approach that does work is Supabase, a hosted database with a free tier. Here's a quick video on getting started with supabase: https://www.youtube.com/watch?v=i_bPeTZVlg0. There are a few other providers but i would recommend this one.
